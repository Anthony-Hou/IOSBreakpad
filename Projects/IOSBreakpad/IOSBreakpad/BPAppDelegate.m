...
//    MyLog *log = [MyLog];
    ...
    NSLog(@"breakPad_ios entered");

    [[BreakpadController sharedInstance]start:YES];
    [[BreakpadController sharedInstance]setUploadingEnabled:YES];

    NSLog(@"breakPad_ios sharedInstance inited");
...
{
     NSLog(@"breakPad_ios applicationWillTerminate before");
    [[BreakpadController sharedInstance]stop];
     NSLog(@"breakPad_ios applicationWillTerminate after");
